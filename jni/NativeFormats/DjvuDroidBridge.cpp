...
extern "C" jlong
Java_org_geometerplus_fbreader_formats_djvu_DjvuContext_create(JNIEnv *env,
                                    jclass cls)
{
...
extern "C" void
Java_org_geometerplus_fbreader_formats_djvu_DjvuContext_free(JNIEnv *env,
                                    jclass cls,
                                    jlong contextHandle)
{
...
extern "C" jlong
Java_org_geometerplus_fbreader_formats_djvu_DjvuDocument_open(JNIEnv *env,
                                    jclass cls,
                                    jlong contextHandle,
                                    jstring fileName)
{
...
extern "C" void
Java_org_geometerplus_fbreader_formats_djvu_DjvuContext_handleMessage(JNIEnv *env,
                                    jobject thiz,
                                    jlong contextHandle)
{
...
extern "C" jlong
Java_org_geometerplus_fbreader_formats_djvu_DjvuDocument_getPage(JNIEnv *env,
                                    jclass cls,
                                    jlong docHandle,
                                    jint pageNumber)
{
...
extern "C" void
Java_org_geometerplus_fbreader_formats_djvu_DjvuDocument_free(JNIEnv *env,
                                    jclass cls,
                                    jlong docHandle)
{
...
extern "C" jint
Java_org_geometerplus_fbreader_formats_djvu_DjvuDocument_getPageCount(JNIEnv *env,
                                    jclass cls,
                                    jlong docHandle)
{
...
extern "C" jboolean
Java_org_geometerplus_fbreader_formats_djvu_DjvuPage_isDecodingDone(JNIEnv *env,
                                    jclass cls,
                                    jlong pageHandle)
{
...
extern "C" jint
Java_org_geometerplus_fbreader_formats_djvu_DjvuPage_getWidth(JNIEnv *env,
                                    jclass cls,
                                    jlong pageHangle)
{
...
extern "C" jint
Java_org_geometerplus_fbreader_formats_djvu_DjvuPage_getHeight(JNIEnv *env,
                                    jclass cls,
                                    jlong pageHangle)
{
...
extern "C" jboolean
Java_org_geometerplus_fbreader_formats_djvu_DjvuPage_renderPage(JNIEnv *env,
                                    jclass cls,
                                    jlong pageHangle,
                                    jint targetWidth,
                                    jint targetHeight,
...
extern "C" void
Java_org_geometerplus_fbreader_formats_djvu_DjvuPage_free(JNIEnv *env,
                                    jclass cls,
                                    jlong pageHangle)
{
