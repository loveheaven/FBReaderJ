...
#ifndef __GUJITEXTFORMAT_H__
#define __GUJITEXTFORMAT_H__
...
public:
	...
	GujiTextFormat(const ZLFile &file);
	~GujiTextFormat() {}
...
friend class GujiTextFormatDetector;
};
...
class GujiTextFormatDetector {

public:
	GujiTextFormatDetector() {}
	~GujiTextFormatDetector() {}

	void detect(ZLInputStream &stream, GujiTextFormat &format);
};
