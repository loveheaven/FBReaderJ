...
private:
	...
	void detectPage(pdf_xref *xref, fz_obj *pageobj, std::string& str);
	void pdf_gettextline(pdf_textline *line, std::string& str);
	void detectEncodingAndLanguage(renderdocument_t *doc);
};
