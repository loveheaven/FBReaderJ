...
public class SelectionAddToKnown extends FBAndroidAction {
	SelectionAddToKnown(FBReader baseApplication, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		...
		BaseActivity.getCollection().bindToService(BaseActivity, new Runnable() {
			...
			@Override
			public void run() {
				BaseActivity.getCollection().saveToKnownWords(new Word(Reader.Model.Book, null, text, 0));
			}
		});
